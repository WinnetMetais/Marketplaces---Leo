...
3. [ ] **Qual é o status agora.** Procurar a tela de solicitações de isenção no Seller Central e ler o status lá, em vez de esperar e-mail. É comum a aprovação sair sem aviso chegar.
4. [ ] Registrar aqui o **ID / número da solicitação** e a **data**.

## Fase 2 — Se estiver aprovada

5. [ ] Anotar a cobertura exata (marca + categorias liberadas)
...
**Nota de fonte:** o comportamento da ferramenta de isenção descrito na Fase 1 (concessão por marca + categoria, tela de status própria) é conhecimento geral da plataforma, **não vem de documento deste repositório**. Confirmar no console antes de decidir com base nisso.
