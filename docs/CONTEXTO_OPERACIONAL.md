...
**As 14 linhas:** O6-001 SP-PP pausar · O6-002 EGC pausar · O6-003 alvo `B09YDLC69D` pausar · O6-004 PI P3070 vigia re-armada · O6-005 loose 0,54 → 0,45 · O6-006 Q2460-B gatilho 28/09 · O6-007 O5-013 cancelada · O6-008 exata "pia de cozinha" vigia · O6-009 O5-014 fechada · O6-010 piloto +1 Era · O6-011 Prime Day (PXM, PG2460, P3070, P3060, P4080, P3050 opcional, **PXP como exceção ao piso por decisão do LEO**) · O6-012 migração NÃO DECIDIR AINDA · O6-013 `B0BHMZBZW9` vigia · O6-014 manutenções. Proposta de colagem em `dados/PROPOSTA_Registro_O6_colar.xlsx` (14 linhas em A63 + vereditos das 17 linhas da O5).
