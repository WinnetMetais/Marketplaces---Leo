...
7. **Divergência `Ref_Frete` × frete real observado em Pequenos (28/08).** Item de **precificação, não de Ads** — mas afeta diretamente os rankings que esta proposta usa. Em 27 pedidos de 1 unidade, 25 pagaram abaixo da tabela (mediana 56%). Se as margens do Simulador estão pessimistas, o lucro unitário de Pequenos está subestimado e a ordem do Núcleo B e da fila profunda muda. Verificar com o Livro de agosto fechado **antes** de fixar a lista final.
