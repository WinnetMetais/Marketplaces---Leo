# O5 — 08/09/2026 · PACOTE DE FECHAMENTO (chat canônico) — **v2, com C4/C5/C6 aplicadas**

> Correções da auditoria do Claude Code aplicadas em 09/09: **C4** lance da auto SP-PP (1,32, não o CPC 1,28) · **C5** 6 de 7 cliques da Era na loose, não 100% · **C6** projeção de setembro pelo ritmo do próprio mês. Nada mais foi alterado.
...
| O5-010 | Auto SP-PP-o425/08 | segmentação `loose-match` | PAUSAR ALVO (segmentação) | Ativa — lance R$ 1,32 nas 4 segmentações | Pausada; **VIGIA da campanha, gatilho O6: 0 cliques relevantes → PAUSAR CAMPANHA** | Pós O4-001, 6 dos 7 cliques da Era (R$ 7,66 de R$ 8,98) vieram da loose em 6 termos "parede" irrelevantes; o 7º clique não aparece no relatório de termos; CTR ~0,06%; vitalício 26 cliques / 0 venda | MÉDIA | `substitutes` permanece pausada (O4-001). Termos: saboneteira parede · suporte planta parede · mandalas decorativas parede · mop para limpar paredes · organizador de fios parede · suporte secador de cabelo parede |
...
**§2 Teto mensal** — R$ 1.000. **Setembro 01–08: R$ 108,08 (console)** = 10,8% do teto consumido. Projeção pelo ritmo do próprio setembro: R$ 13,51/dia (8 dias corridos) a R$ 15,44/dia (7 dias completos; 08/09 incompleto) → **R$ 405 a R$ 463/mês, 41% a 46% do teto**. Folga ampla. (Nota: o ritmo da Era, R$ 16,23/dia, é mais alto porque carrega 26–31/08 — não usar para projetar setembro.)
